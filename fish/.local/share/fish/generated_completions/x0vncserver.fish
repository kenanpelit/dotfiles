...
complete -c x0vncserver -o RSAKey -d 'Path to the RSA key for the RSA-AES security types (RA2, RA2ne, RA2_256 and R…'
complete -c x0vncserver -o RequireUsername -d 'Require username for the RSA-AES security types.  Default is off'
