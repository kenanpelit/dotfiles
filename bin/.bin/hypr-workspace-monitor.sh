...
# window manager. It manages operations such as monitor switching,
# workspace changing, and window focus control.
#
# Requirements:
...
show_help() {
  ...
  echo "╚══════════════════════════════════╝"
  echo
  echo "Usage: $0 [-h] [-ms] [-msf] [-mt] [-wt] [-wr] [-wl] [-vn] [-vp] [-vl] [-vr]"
  echo
  echo "Options:"
