...
TEMP_DAY=4000        # Gündüz sıcaklığı (6000K)
TEMP_EVENING=3800    # Akşam sıcaklığı (5000K)
TEMP_NIGHT=3600      # Gece sıcaklığı (4000K)
TEMP_LATE_NIGHT=3400 # Geç gece sıcaklığı (3500K)
